                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="b-two-text">
                            ...
                            <p>Bienvenue dans notre clinique, où nous nous engageons à fournir des soins de santé de qualité
                                supérieure. Notre équipe de professionnels est là pour répondre à vos besoins médicaux avec
                                compétence et compassion.</p>
                            <div class="b-two-btn">
            ...
            <div class="dedicated-slider owl-carousel owl-theme">
                <div class="dedicated-card">
                    ...
                    <div class="d-card-text">
                        ...
                        <p>Nos médecins sont à votre disposition pour des consultations complètes, adaptées à vos besoins de
                            santé.</p>
                ...
                <div class="dedicated-card">
                    ...
                    <div class="d-card-text">
                        ...
                        <p>Nous offrons des soins infirmiers de qualité pour assurer votre bien-être et votre
                            rétablissement.</p>
                        <div class="d-card-btn">
                            <a href="{{ route('detail_ervice') }}" class="default-btn two">
                                En savoir plus
                ...
                <div class="dedicated-card">
                    ...
                    <div class="d-card-text">
                        ...
                        <p>Nos experts sont là pour vous fournir des conseils médicaux personnalisés pour une meilleure
                            santé.</p>
                        <div class="d-card-btn">
                            <a href="{{ route('detail_ervice') }}" class="default-btn two">
                                En savoir plus
        ...
        <div class="container">
            ...
            <div class="treatment-slider owl-carousel owl-theme">
                <div class="treatment-card bg-color-1">
                    ...
                    <p>Nos médecins hautement qualifiés sont là pour vous fournir des soins de qualité, adaptés à vos
                ...
                <div class="treatment-card bg-color-1">
                    ...
                    <p>Notre clinique est équipée des technologies médicales les plus récentes pour garantir des diagnostics
                        et des traitements précis.</p>
                    <div class="t-card-btn">
                        <a href="{{ route('detail_ervice') }}" class="default-btn two">
                            En savoir plus
                            <span></span>
                ...
                <div class="treatment-card bg-color-1">
                    ...
                    <p>Nous offrons un service d'urgence 24/7 pour répondre rapidement à toutes vos situations critiques.
                    </p>
                    <div class="t-card-btn">
                        <a href="{{ route('detail_ervice') }}" class="default-btn two">
                            En savoir plus
                ...
                <div class="treatment-card bg-color-1">
                    ...
                    <p>Nous offrons des soins personnalisés pour chaque patient, en tenant compte de ses besoins et de son
                        état de santé.</p>
                    <div class="t-card-btn">
                        <a href="{{ route('detail_ervice') }}" class="default-btn two">
                            En savoir plus
                            ...
                            <div class="caption">
                                <div class="caption-text">
                                    ...
                                    <a href="#"><span class="__cf_email__"
                                            data-cfemail="b6d1dad3d8d8c4dfdad3cff6d1dbd7dfda98d5d9db">[email&#160;protected]</span></a>
                                    <ul>
                                        <li>
                        ...
                        <div class="d-table-cell">
                            <div class="caption">
                                <div class="caption-text">
                                    ...
                                    <a href="#"><span class="__cf_email__"
                                            data-cfemail="9efbedeafbf2fff6f1e9fbeceaf1f0def9f3fff7f2b0fdf1f3">[email&#160;protected]</span></a>
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/" target="_blank">
                                                <i class="bx bxl-facebook"></i>
                        ...
                        <div class="d-table-cell">
                            <div class="caption">
                                <div class="caption-text">
                                    ...
                                    <a href="#"><span class="__cf_email__"
                                            data-cfemail="8fe5eee2eafcf8e0fde4e2eee1cfe8e2eee6e3a1ece0e2">[email&#160;protected]</span></a>
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/" target="_blank">
                                                <i class="bx bxl-facebook"></i>
                        ...
                        <div class="d-table-cell">
                            <div class="caption">
                                <div class="caption-text">
                                    ...
                                    <p>Spécialiste des chiens</p>
                                    <a href="#"><span class="__cf_email__"
                                            data-cfemail="b6c2d9db98ded3d8c4cff6d1dbd7dfda98d5d9db">[email&#160;protected]</span></a>
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/" target="_blank">
                                                <i class="bx bxl-facebook"></i>
                ...
                <div class="col-lg-6">
                    <div class="offer-text">
                        <div class="section-title-two">
                            ...
                            <p>Nous sommes l'un des meilleurs fournisseurs de services et nous offrons les meilleures offres
                                à nos clients dévoués. Nous avons des offres initiales pour nos clients fidèles. Cela est
                                vraiment efficace pour nous. Vous pouvez facilement obtenir un résultat positif et innovant
                                grâce à cette agence et à notre offre.</p>
                            <p>D'autre part, nous condamnons avec indignation et méprisons les hommes qui sont si séduits et
                                démoralisés par les charmes du plaisir du moment, si aveuglés par le désir, qu'ils ne
                                peuvent prévoir la douleur et les ennuis.</p>
                        </div>
                        <ul>
                            <li>
        ...
        <div class="container">
            ...
            <div class="clients-slider owl-carousel owl-theme">
                <div class="clients-card">
                    ...
                    <p>Cette clinique possède les technologies les plus avancées et les médecins sont très qualifiés. Cela
                        renforce notre confiance en leurs services.</p>
                ...
                <div class="clients-card">
                    ...
                    <p>J'ai commencé à travailler avec cette agence et elle nous offre un soutien spécial sur le marché
                        mondial. L'équipe est brillante pour les traitements.</p>
                    <div class="clients-name">
                        <h3>Awa Ndoye</h3>
