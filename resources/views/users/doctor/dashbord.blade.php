                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="doctor-widget border-right-bg">
                            ...
                            <div class="doctor-content dash-count flex-grow-1">
                                <h4>
                                    <span class="counter-up">30</span><span>/85</span><span class="status-green">+60%</span>
                                </h4>
                                <h5>Appointments</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="doctor-widget border-right-bg">
                            ...
                            <div class="doctor-content dash-count flex-grow-1">
                                <h4>
                                    <span class="counter-up">20</span><span>/125</span><span class="status-pink">-20%</span>
                                </h4>
                                <h5>Consultations</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="doctor-widget border-right-bg">
                            ...
                            <div class="doctor-content dash-count flex-grow-1">
                                <h4>
                                    <span class="counter-up">12</span><span>/30</span><span class="status-green">+40%</span>
                                </h4>
                                <h5>Operations</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="doctor-widget">
                            ...
                            <div class="doctor-content dash-count flex-grow-1">
                                <h4>
                                    $<span class="counter-up">530</span><span></span><span class="status-green">+50%</span>
                                </h4>
                                <h5>Earnings</h5>
                            </div>
                        </div>
                    ...
                    <div class="struct-point">
                        <div class="card patient-structure">
                            <div class="card-body">
                                <h5>New Patients</h5>
                                <h3>
                                    56<span class="status-green"><img src="{{ asset('assets/assets/img/icons/sort-icon-01.svg') }}" alt
                                            class="me-1" />60%</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card patient-structure">
                            <div class="card-body">
                                <h5>Old Patients</h5>
                                <h3>
                                    35<span class="status-pink"><img src="{{ asset('assets/assets/img/icons/sort-icon-02.svg') }}" alt
                                            class="me-1" />-20%</span>
                                </h3>
                            </div>
                        </div>
                            ...
                            <div class="chart-title patient-visit">
                                ...
                                <div>
                                    <ul class="nav chat-user-total">
                                        <li>
                                            <i class="fa fa-circle low-users" aria-hidden="true"></i>Low
                                        </li>
                                        <li>
                                        ...
                                        <table class="table mb-0 border-0 custom-table">
                                            <tbody>
                                                <tr>
                                                    <td class="table-image appoint-doctor">
                                                        <img width="28" height="28" class="rounded-circle"
                                                            src="{{ asset('assets/assets/img/profiles/avatar-02.jpg') }}" alt />
                                                ...
                                                <tr>
                                                    <td class="table-image appoint-doctor">
                                                        <img width="28" height="28" class="rounded-circle"
                                                            src="{{ asset('assets/assets/img/profiles/avatar-03.jpg') }}" alt />
                                                ...
                                                <tr>
                                                    <td class="table-image appoint-doctor">
                                                        <img width="28" height="28" class="rounded-circle"
                                                            src="{{ asset('assets/assets/img/profiles/avatar-04.jpg') }}" alt />
                                                        <h2>Dr.Martin Doe</h2>
                                                    </td>
                                                    <td class="appoint-time text-center">
                                                        <h6>Today 5:40 PM</h6>
                                            ...
                                            <ul class="doctor-date-list mb-2">
                                                ...
                                                <li class="dropdown ongoing-blk">
                                                    <a href="#" class="dropdown-toggle active-doctor"
                                                        ...
                                                        <span>Andrea Lalema</span><span class="ongoing-drapt">Ongoing
                                                            ...
                                                            <ul class="nav schedule-time">
                                                                <li>
                                                                    <a href="javascript:;"><img
                                                                            src="{{ asset('assets/assets/img/icons/trash.svg') }}" alt /></a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:;"><img
                                                                            src="{{ asset('assets/assets/img/icons/profile.svg') }}" alt /></a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:;"><img
                                                                            src="{{ asset('assets/assets/img/icons/edit.svg') }}" alt /></a>
                                                                </li>
                                                            </ul>
