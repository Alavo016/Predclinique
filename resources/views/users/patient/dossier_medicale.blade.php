        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mt-4">
                        <div class="card-header bg-primary text-white">
                            <h5 class="card-title text-white">Historique des Consultations</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="consultation mb-4 ">
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($consultation->ordonnance)
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="ordonnanceModal{{ $consultation->id }}"
                                                tabindex="-1" role="dialog" aria-labelledby="ordonnanceModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="ordonnanceModalLabel">Ordonnance
                                                            </h5>
