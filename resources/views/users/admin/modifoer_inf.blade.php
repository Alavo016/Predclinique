...
@section('title', 'Admin modifier infirmier')
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Modifier un infirmier </li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('adm_infirmier.update',$infirmier->id) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Votre prénom"
                                                name="prenom" value="{{ $infirmier->prenom }}">
                                        </div>
                                        @error('prenom')
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Votre nom de famille"
                                                name="name" value="{{ $infirmier->name }}">
                                        </div>
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-4">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Nom d'utilisateur"
                                                name="pseudo" value="{{ $infirmier->pseudo }}">
                                        </div>
                                        @error('pseudo')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Votre numéro de mobile"
                                                name="telephone" value="{{ $infirmier->telephone }}">
                                        </div>
                                        @error('telephone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="email" placeholder="Votre adresse e-mail"
                                                name="email" value="{{ $infirmier->email }}">
                                        </div>
                                        @error('email')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms cal-icon">
                                            ...
                                            <input class="form-control datetimepicker" type="date" name="date_naissance"
                                                value="{{ $infirmier->date_naissance }}">
                                        </div>
                                            ...
                                            <select class="form-control select" name="specialite">
                                                @foreach ($specialites as $specialite)
                                                    <option value="{{ $specialite->id }}"
                                                        {{ $infirmier->specialite_id == $specialite->id ? 'selected' : '' }}>
                                                        {{ $specialite->nom }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12 col-sm-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <textarea class="form-control" rows="3" cols="30" placeholder="Votre adresse" name="address">{{ $infirmier->address }} </textarea>
                                        </div>
                                        @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input type="text" name="ville" class="form-control" value="{{ $infirmier->ville }}">
                                        </div>
                                        @error('ville')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input type="text" name="nationalite" class="form-control" value="{{ $infirmier->nationalite }}">
                                        </div>
                                        @error('nationalité')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
