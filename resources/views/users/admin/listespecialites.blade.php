...
@section('title', 'Admin Liste specialites')
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Liste des specialites</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col">
                                        <div class="doctor-table-blk">
                                            ...
                                            <div class="doctor-search-blk">
                                                ...
                                                <div class="add-group">
                                                    <a href="{{ route('adm_specialites.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($specialites as $specialite)
                                            <tr>
                                                ...
                                                <td>{{ $specialite->prix }} F CFA</td>
                                                <td class="text-end">



                                                        <a class="btn btn-outline-success"
                                                            href="{{ route('adm_specialites.edit', $specialite->id) }}">
                                                            <i class="fa-solid fa-pen-to-square m-r-5"></i> Edit
                                                        </a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('adm_specialites.destroy', $specialite->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div id="delete_specialite" class="modal fade delete-modal" role="dialog">
