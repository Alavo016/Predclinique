            ...
            <ul>
                ...
                <li class="submenu">
                    <a href="{{ route('admin.dashboard') }}"><span class="menu-side"><img
                        ...
                        <span> Admin Dashboard</span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">

                        <li><a class="active" href="#">Statitique</a></li>
                ...
                <li class="submenu">
                    <a href="#"><span class="menu-side"><img
                                src="{{ asset('assets/assets/img/icons/menu-icon-11.svg') }}" alt></span>
                ...
                <li class="submenu">
                    <a href="#"><span class="menu-side"><img
                                src="{{ asset('assets/assets/img/icons/menu-icon-12.svg') }}" alt></span>
                ...
                <li class="submenu">
                    <a href="#"><span class="menu-side"><img
                                src="{{ asset('assets/assets/img/icons/menu-icon-13.svg') }}" alt></span>
                ...
                <li>
                    <a href="assets/assets.html"><i class="fa fa-cube"></i> <span>assets/</span></a>
                </li>
                <li>
                ...
                <li class="submenu">
                    <a href="#"><span class="menu-side"><img
                                src="{{ asset('assets/assets/img/icons/menu-icon-15.svg') }}" alt></span>
