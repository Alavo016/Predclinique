...
@section('title', 'Admin Ajout Patient')
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Ajout d'un Patient </li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card p-2">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('adm_Patient.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
