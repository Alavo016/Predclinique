<div class="header">
    <div class="header-left">
        <a href="index.html" class="logo">
            <img src="{{ asset('1-removebg-preview.png') }}" width="35" height="35" alt> <span>E-clinique</span>
        </a>
    </div>
    ...
    <ul class="nav user-menu float-end">
                    ...
                    <ul class="notification-list">
                        <li class="notification-message">
                            <a href="activities.html">
                                <div class="media">
                                    <span class="avatar">
                                        <img alt="John Doe" src="{{ asset('assets/assets/img/user.jpg') }}"
                                            class="img-fluid">
                                    </span>
        ...
        <li class="nav-item dropdown d-none d-md-block">
            <a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><img
                    src="{{ asset('assets/assets/img/icons/note-icon-01.svg') }}" alt><span class="pulse"></span> </a>
        </li>
