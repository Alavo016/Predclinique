        ...
        <div class="content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Modification d'une créance</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('Creance.update', $creance->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-heading">
                                            <h4>Modification Créance</h4>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-xl-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <input type="text" class="form-control" id="search_patient"
                                                list="patients" placeholder="Rechercher un patient" value="{{ $creance->user->name }} {{ $creance->user->prenom }}">
                                            ...
                                            <select class="form-control d-none" name="patient_id" id="patient_id">
                                                @foreach ($patients as $patient)
                                                    <option value="{{ $patient->id }}" {{ $creance->patient_id == $patient->id ? 'selected' : '' }}>{{ $patient->name }} {{ $patient->prenom }}</option>
                                                @endforeach
                                            </select>
                                            @error('patient_id')
                                    ...
                                    <div class="col-12 col-md-6 col-xl-12">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" name="montant_tot" value="{{ $creance->montant_tot }}">
                                            @error('montant_tot')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" name="montant_res" value="{{ $creance->montant_res }}">
                                            @error('montant_res')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 col-xl-6">
                                        <div class="input-block local-forms">
                                            ...
                                            <input class="form-control" type="text" name="montant_paye" value="{{ $creance->montant_paye }}">
                                            @error('montant_paye')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
